...
public class BaseMethods extends BaseTest {
    ...
    protected void scrollToElement(By by) {
        ...
        String command = "arguments[0].scrollIntoViewIfNeeded();";
        executeScript(command, webElement);
    }
    protected static Object executeScript(String jsCommand, Object... args) {

        JavascriptExecutor javascriptExecutor = (JavascriptExecutor) driver;
        return javascriptExecutor.executeScript(jsCommand, args);
    }
